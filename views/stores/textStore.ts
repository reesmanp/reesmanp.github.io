...
const Welcome = Map({
  Välkommen: Map({
    ...
    'Open Source Projects I Contribute To': '<a href="https://github.com/react-materialize/react-materialize" target="_blank">React Materialize (Collaborator Status)</a><br /><a href="https://github.com/PCGen/pcgen" target="_blank">PCGen</a>'
  })
});
